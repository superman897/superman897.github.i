	...
	return function b(a, c, d) {
		...
		14: [function(a, b, c) {
			...
			d.prototype.cloneTo = function(a) {
				...
				return "SELECT" === this.node.tagName ? a = e(this.node) : "password" === this.node.type && (a = Array(a.length + 1).join("â€¢")), 0 === a.length ? this.node.placeholder || "" : a
		...
		15: [function(a, b, c) {
			...
			d.prototype.calculateOverflowClips = function() {
				...
				var b = a.parseBounds(),
					...
					i = j(d, f, g);
				this.renderer.clip(a.backgroundClip, function() {
					this.renderer.rectangle(d.left + 1, d.top + 1, d.width - 2, d.height - 2, new U("#DEDEDE")), this.renderer.renderBorders(h(g, d, i, f)), a.node.checked && (this.renderer.font(new U("#424242"), "normal", "normal", "bold", c - 3 + "px", "arial"), this.renderer.text("âœ”", d.left + c / 6, d.top + c - 1))
				}, this)
