    ...
    return function e(t, r, n) {
        ...
        1: [function(e, t, r) {
            ...
            function n(e, t, r) {
                ...
                return r = r || {},
                o["default"].getAnalyticsController().track(e, t)._thenRunCallbacks(r)
            }
        ...
        2: [function(e, t, r) {
            ...
            function n(e, t, r) {
                ...
                var n = {};
                return r.useMasterKey && (n.useMasterKey = r.useMasterKey),
            ...
            o["default"].setCloudController({
                run: function(e, t, r) {
                    ...
                    c["default"])(t, !0)
                      , s = {};
                    r.hasOwnProperty("useMasterKey") && (s.useMasterKey = r.useMasterKey),
                    r.hasOwnProperty("sessionToken") && (s.sessionToken = r.sessionToken);
                    ...
                    if (e && "string" != typeof e) {
                        ...
                        if (t)
                            for (var n in t)
                                r[n] = t[n];
                        return r.authData = e,
                        l["default"]._logInWith("facebook", r)
                    }
                    if (!c)
                        throw new Error("You must initialize FacebookUtils before calling logIn.");
                    return a = e,
                    l["default"]._logInWith("facebook", t)
                },
                link: function(e, t, r) {
                    if (t && "string" != typeof t) {
                        ...
                        if (r)
                            for (var s in r)
                                n[s] = r[s];
                        return n.authData = t,
                        e._linkWith("facebook", n)
                    }
                    if (!c)
                        throw new Error("You must initialize FacebookUtils before calling link.");
                    return a = t,
                    e._linkWith("facebook", r)
                },
                unlink: function(e, t) {
                    if (!c)
        ...
        6: [function(e, t, r) {
            ...
            function s(e, t) {
                var r = n(e, t);
                return null === r ? null : (delete N[e][t],
                r)
            }
            function o(e, t) {
                var r = n(e, t);
            ...
            function i(e, t, r) {
                ...
                for (var s in r)
                    "undefined" != typeof r[s] ? n[s] = r[s] : delete n[s]
            }
            function u(e, t) {
                var r = n(e, t);
            ...
            function p(e, t, r) {
                for (var n = o(e, t), a = n[r], s = u(e, t), i = 0; i < s.length; i++)
                    s[i][r] && (a = s[i][r]instanceof T.RelationOp ? s[i][r].applyTo(a, {
                        className: e,
                        id: t
                    }, r) : s[i][r].applyTo(a));
                return a
            ...
            function y(e, t) {
                ...
                for (var s = u(e, t), i = 0; i < s.length; i++)
                    for (r in s[i])
                        s[i][r]instanceof T.RelationOp ? n[r] = s[i][r].applyTo(n[r], {
                            className: e,
                            id: t
            ...
            function v(e, t, r) {
                ...
                for (var s in r) {
                    var o = r[s];
                    if (n.serverData[s] = o,
                    o && "object" == typeof o && !(o instanceof k["default"]) && !(o instanceof C["default"]) && !(o instanceof S["default"])) {
                        var i = (0,
                        w["default"])(o, !1, !0);
        ...
        7: [function(e, t, r) {
            ...
            var n = e("babel-runtime/helpers/interop-require-default")["default"]
              ...
              , m = {
                initialize: function(e, t) {
                    c["default"].get("IS_NODE") && console.log("It looks like you're using the browser version of the SDK in a node.js environment. You should require('parse/node') instead."),
                    m._initialize(e, t)
                },
            ...
            m.ACL = e("./ParseACL"),
            m.Analytics = e("./Analytics"),
            m.Cloud = e("./Cloud"),
            m.CoreManager = e("./CoreManager"),
            m.Config = e("./ParseConfig"),
            m.Error = e("./ParseError"),
            m.FacebookUtils = e("./FacebookUtils"),
            m.File = e("./ParseFile"),
            m.GeoPoint = e("./ParseGeoPoint"),
            m.Installation = e("./ParseInstallation"),
            m.Object = e("./ParseObject"),
            m.Op = {
                Set: p.SetOp,
                Unset: p.UnsetOp,
            ...
            m.Promise = e("./ParsePromise"),
            m.Push = e("./Push"),
            m.Query = e("./ParseQuery"),
            m.Relation = e("./ParseRelation"),
            m.Role = e("./ParseRole"),
            m.Session = e("./ParseSession"),
            m.Storage = e("./Storage"),
            m.User = e("./ParseUser"),
            m._request = function() {
            ...
            var i = e("./ParseRole")
              ...
              , d = function() {
                function e(t) {
                    ...
                    t && "object" == typeof t)
                        if (t instanceof c["default"])
                            this.setReadAccess(t, !0),
                            this.setWriteAccess(t, !0);
                        else
                            for (var r in t) {
                                var n = t[r];
                                if ("string" != typeof r)
                ...
                return n(e, [{
                    ...
                    value: function() {
                        var e = {};
                        for (var t in this.permissionsById)
                            e[t] = this.permissionsById[t];
                        return e
                    }
                }, {
                    key: "equals",
                    value: function(t) {
                        ...
                        for (var a in this.permissionsById) {
                            if (!t.permissionsById[a])
                                return !1;
                            if (this.permissionsById[a].read !== t.permissionsById[a].read)
                                return !1;
                            if (this.permissionsById[a].write !== t.permissionsById[a].write)
                                return !1
                        }
                        return !0
                    }
                    ...
                    value: function(e, t, r) {
                        if (t instanceof c["default"] ? t = t.id : t instanceof u["default"] && (t = "role:" + t.getName()),
                        "string" != typeof t)
                        ...
                        0 === s(n).length && delete this.permissionsById[t])
                    }
                }, {
                    key: "_getAccess",
                    value: function(e, t) {
                    ...
                    value: function(e) {
                        if (e instanceof u["default"] && (e = e.getName()),
                        "string" != typeof e)
                ...
                get: function() {
                    ...
                    return e.request("GET", "config", {}, {}).then(function(e) {
                        ...
                        for (var n in e.params)
                            r.attributes[n] = (0,
                            c["default"])(e.params[n]);
                        return w = r,
                        _["default"].setItemAsync(_["default"].generatePath(O), JSON.stringify(e.params)).then(function() {
                            return r
                        })
                    })
                }
        ...
        11: [function(e, t, r) {
            ...
            u["default"].setFileController({
                ...
                saveBase64: function(e, t) {
                    ...
                    return t.type && (r._ContentType = t.type),
        ...
        12: [function(e, t, r) {
            ...
            var o = e("./ParsePromise")
              ...
              , u = function() {
                function e(t, r) {
                    a(this, e),
                    Array.isArray(t) ? (e._validate(t[0], t[1]),
                    this._latitude = t[0],
                    this._longitude = t[1]) : "object" == typeof t ? (e._validate(t.latitude, t.longitude),
                    this._latitude = t.latitude,
                    this._longitude = t.longitude) : "number" == typeof t && "number" == typeof r ? (e._validate(t, r),
                    this._latitude = t,
                    this._longitude = r) : (this._latitude = 0,
                    this._longitude = 0)
                }
                return n(e, [{
                    key: "toJSON",
                    ...
                    value: function(e) {
                        ...
                        return u = Math.min(1, u),
                        2 * Math.asin(Math.sqrt(u))
                    }
                }, {
                    key: "kilometersTo",
                    value: function(e) {
        ...
        13: [function(e, t, r) {
            ...
            var i = e("./ParseObject")
              ...
              , l = function(e) {
                function t(e) {
                    if (s(this, t),
                    n(Object.getPrototypeOf(t.prototype), "constructor", this).call(this, "_Installation"),
              ...
              , z = function() {
                ...
                return a(e, [{
                    ...
                    value: function() {
                        ...
                        for (var a in t) {
                            var s = t[a];
                            if (s && "object" == typeof s && !(s instanceof e) && !(s instanceof N["default"]) && !(s instanceof L["default"]))
                                try {
                                    var o = (0,
                                    _["default"])(s, !1, !0)
                                      , i = JSON.stringify(o);
                    ...
                    value: function(e) {
                        ...
                        P.initializeState(this.className, this._getStateIdentifier());
                        var t = {};
                        for (var r in e)
                            "ACL" === r ? t[r] = new A["default"](e[r]) : "objectId" !== r && (t[r] = (0,
                            m["default"])(e[r]),
                            t[r]instanceof L["default"] && t[r]._ensureParentAndKey(this, r));
                        t.createdAt && "string" == typeof t.createdAt && (t.createdAt = (0,
                        S["default"])(t.createdAt)),
                        t.updatedAt && "string" == typeof t.updatedAt && (t.updatedAt = (0,
                        S["default"])(t.updatedAt)),
                        !t.updatedAt && t.createdAt && (t.updatedAt = t.createdAt),
                        P.commitServerChanges(this.className, this._getStateIdentifier(), t)
                    }
                }, {
                    key: "_setExisted",
                    value: function(e) {
                    ...
                    value: function(e) {
                        if (this._localId && e) {
                            ...
                            t && P.initializeState(this.className, this._getStateIdentifier(), t)
                        }
                    }
                }, {
                    key: "_handleSaveResponse",
                    value: function(e, t) {
                        var r, n = {}, a = P.popPendingState(this.className, this._getStateIdentifier());
                        for (r in a)
                            a[r]instanceof R.RelationOp ? n[r] = a[r].applyTo(void 0, this, r) : r in e || (n[r] = a[r].applyTo(void 0));
                        for (r in e)
                            "createdAt" !== r && "updatedAt" !== r || "string" != typeof e[r] ? "ACL" === r ? n[r] = new A["default"](e[r]) : "objectId" !== r && (n[r] = (0,
                            m["default"])(e[r])) : n[r] = (0,
                            S["default"])(e[r]);
                        n.createdAt && !n.updatedAt && (n.updatedAt = n.createdAt),
                        this._migrateId(e.objectId),
                        201 !== t && this._setExisted(!0),
                        P.commitServerChanges(this.className, this._getStateIdentifier(), n)
                    }
                }, {
                    ...
                    value: function(e) {
                        var t = this.id ? this.className + ":" + this.id : this
                          ...
                          , n = this.attributes;
                        for (var a in n)
                            "createdAt" !== a && "updatedAt" !== a || !n[a].toJSON ? r[a] = (0,
                            _["default"])(n[a], !1, !1, e) : r[a] = n[a].toJSON();
                        var s = this._getPendingOps();
                        for (var a in s[0])
                            r[a] = s[0][a].toJSON();
                        return this.id && (r.objectId = this.id),
                        r
                    }
                }, {
                    key: "equals",
                    ...
                    value: function(e, t, r) {
                        ...
                        for (var o in n)
                            if ("createdAt" !== o && "updatedAt" !== o) {
                                ...
                                r.unset ? a[o] = new R.UnsetOp : n[o]instanceof R.Op ? a[o] = n[o] : n[o] && "object" == typeof n[o] && "string" == typeof n[o].__op ? a[o] = (0,
                                R.opFromJSON)(n[o]) : "objectId" === o || "id" === o ? this.id = n[o] : "ACL" !== o || "object" != typeof n[o] || n[o]instanceof A["default"] ? a[o] = new R.SetOp(n[o]) : a[o] = new R.SetOp(new A["default"](n[o]))
                            }
                        var i = this.attributes
                          , u = {};
                        for (var l in a)
                            a[l]instanceof R.RelationOp ? u[l] = a[l].applyTo(i[l], this, l) : a[l]instanceof R.UnsetOp || (u[l] = a[l].applyTo(i[l]));
                        if (!r.ignoreValidation) {
                            var c = this.validate(u);
                            if (c)
                                return "function" == typeof r.error && r.error(this, c),
                                !1
                        }
                    ...
                    value: function t() {
                        ...
                        return t.className || (t.className = this.className),
                        t.set && t.set(this.attributes),
                        t
                    }
                }, {
                    key: "isNew",
                    ...
                    key: "validate",
                    value: function(e) {
                        if (e.hasOwnProperty("ACL") && !(e.ACL instanceof A["default"]))
                            return new I["default"](I["default"].OTHER_CAUSE,"ACL must be a Parse ACL.");
                        for (var t in e)
                            if (!/^[A-Za-z][0-9A-Za-z_]*$/.test(t))
                                return new I["default"](I["default"].INVALID_KEY_NAME);
                        return !1
                    }
                }, {
                    key: "getACL",
                    ...
                    value: function(e, t, r) {
                        var n, a, s = this;
                        if ("object" == typeof e || "undefined" == typeof e ? (n = e,
                        a = t) : (n = {},
                        n[e] = t,
                        a = r),
                        !a && n && (a = {},
                        "function" == typeof n.success && (a.success = n.success,
                        delete n.success),
                        "function" == typeof n.error && (a.error = n.error,
                        delete n.error)),
                        n) {
                            var o = this.validate(n);
                            if (o)
                                return a && "function" == typeof a.error && a.error(this, o),
                                x["default"].error(o);
                            this.set(n, a)
                        }
                        a = a || {};
                    ...
                    value: function(e) {
                        e = e || {};
                        var t = {};
                        return e.hasOwnProperty("useMasterKey") && (t.useMasterKey = e.useMasterKey),
                        e.hasOwnProperty("sessionToken") && (t.sessionToken = e.sessionToken),
                        this.id ? h["default"].getObjectController().destroy(this, t)._thenRunCallbacks(e) : x["default"].as()._thenRunCallbacks(e)
                    }
                }, {
                    key: "attributes",
                    get: function() {
                    ...
                    value: function(e, t) {
                        ...
                        h["default"].getObjectController().fetch(e, !0, r)._thenRunCallbacks(t)
                    }
                }, {
                    ...
                    value: function(e, t) {
                        ...
                        return t.hasOwnProperty("useMasterKey") && (r.useMasterKey = t.useMasterKey),
                        t.hasOwnProperty("sessionToken") && (r.sessionToken = t.sessionToken),
                        h["default"].getObjectController().fetch(e, !1, r)._thenRunCallbacks(t)
                    }
                }, {
                    key: "destroyAll",
                    value: function(e, t) {
                        ...
                        return t.hasOwnProperty("useMasterKey") && (r.useMasterKey = t.useMasterKey),
                        t.hasOwnProperty("sessionToken") && (r.sessionToken = t.sessionToken),
                        h["default"].getObjectController().destroy(e, r)._thenRunCallbacks(t)
                    }
                }, {
                    key: "saveAll",
                    value: function(e, t) {
                        ...
                        return t.hasOwnProperty("useMasterKey") && (r.useMasterKey = t.useMasterKey),
                        t.hasOwnProperty("sessionToken") && (r.sessionToken = t.sessionToken),
                        h["default"].getObjectController().save(e, r)._thenRunCallbacks(t)
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        var r = W[t.className]
                          ...
                          , a = {};
                        for (var s in t)
                            "className" !== s && "__type" !== s && (a[s] = t[s]);
                        return n._finishFetch(a),
                        t.objectId && n._setExisted(!0),
                        n
                    }
                }, {
                    ...
                    value: function(t, r, n) {
                        ...
                        var o = function(e, t) {
                            if ("function" == typeof this.initialize && this.initialize.apply(this, arguments),
                            this.className = a,
                            this._objCount = G++,
            ...
            h["default"].setObjectController({
                fetch: function(e, t, r) {
                    if (Array.isArray(e)) {
                        ...
                        if (e.forEach(function(e, r) {
                            u || (s || (s = e.className),
                            s !== e.className && (u = new I["default"](I["default"].INVALID_CLASS_NAME,"All objects should be of the same class")),
                            e.id || (u = new I["default"](I["default"].MISSING_OBJECT_ID,"All objects must have an ID")),
                            (t || 0 === o(e._getServerData()).length) && (a.push(e.id),
                            n.push(e)),
                            i.push(e))
                        }),
                        u)
                            return x["default"].error(u);
                        var l = new U["default"](s);
                        return l.containedIn("objectId", a),
                        l._limit = a.length,
                        l.find(r).then(function(e) {
                            ...
                            for (var a = 0; a < n.length; a++) {
                                var s = n[a];
                                if ((!s || !s.id || !r[s.id]) && t)
                                    return x["default"].error(new I["default"](I["default"].OBJECT_NOT_FOUND,"All objects must exist on the server."))
                            }
                            if (!V)
                    ...
                    return c.request("GET", "classes/" + e.className + "/" + e._getId(), {}, r).then(function(t, r, n) {
                        return e instanceof z && (e._clearPendingOps(),
                        e._finishFetch(t)),
                        e
                    })
                },
                destroy: function(e, t) {
                    ...
                    if (Array.isArray(e)) {
                        ...
                        var a = [[]];
                        e.forEach(function(e) {
                            e.id && (a[a.length - 1].push(e),
                            a[a.length - 1].length >= 20 && a.push([]))
                        }),
                ...
                save: function(e, t) {
                    ...
                    if (Array.isArray(e)) {
                        if (e.length < 1)
                            return x["default"].as([]);
                        for (var a = e.concat(), s = 0; s < e.length; s++)
                            e[s]instanceof z && (a = a.concat((0,
                            J["default"])(e[s], !0)));
                        a = (0,
                        K["default"])(a);
                        var o = x["default"].as()
                        ...
                        o.then(function() {
                            ...
                            return x["default"]._continueWhile(function() {
                                ...
                                if (i.forEach(function(t) {
                                    e.length < 20 && (0,
                                    y["default"])(t) ? e.push(t) : s.push(t)
                                }),
                                i = s,
                                e.length < 1)
                                    return x["default"].error(new I["default"](I["default"].OTHER_CAUSE,"Tried to save a batch with a cycle."));
                                var o = new x["default"]
                                  , u = []
                                  , l = [];
                                return e.forEach(function(e, t) {
                                    ...
                                    var n = function() {
                                        ...
                                        o.then(function(r, n) {
                                            if (r[t].hasOwnProperty("success"))
                                                e._handleSaveResponse(r[t].success, n);
                                            else {
                                                if (!a && r[t].hasOwnProperty("error")) {
                                                    var s = r[t].error;
                                                    a = new I["default"](s.code,s.error),
                                                    i = []
                                                }
                                                e._handleSaveError()
                                            }
                                    ...
                                    P.pushPendingState(e.className, e._getStateIdentifier()),
                                    l.push(P.enqueueTask(e.className, e._getStateIdentifier(), n))
                                }),
                                x["default"].when(u).then(function() {
                                    return r.request("POST", "batch", {
                                        requests: e.map(function(e) {
                                            var t = e._getSaveParams();
                                            return t.path = n() + t.path,
                                            t
                                        })
                                    }, t)
                                }).then(function(e, t, r) {
                        ...
                        var u = e
                          , l = function() {
                            ...
                            return r.request(e.method, e.path, e.body, t).then(function(e, t) {
                                ...
                                return u._handleSaveError(),
                                x["default"].error(e)
                            })
                        };
                        return P.pushPendingState(e.className, e._getStateIdentifier()),
                        P.enqueueTask(e.className, e._getStateIdentifier(), l).then(function() {
                            return e
                        }, function(e) {
                            return e
                        })
        ...
        15: [function(e, t, r) {
            ...
            function n(e) {
                ...
                case "Batch":
                    for (var t = [], r = [], n = 0; n < e.ops.length; n++)
                        "AddRelation" === e.ops[n].__op ? t = t.concat((0,
                        d["default"])(e.ops[n].objects)) : "RemoveRelation" === e.ops[n].__op && (r = r.concat((0,
                        d["default"])(e.ops[n].objects)));
                    return new S(t,r)
                }
                return null
            }
                ...
                a(t, [{
                    ...
                    value: function(e) {
                        if (!e)
                            return this;
                        if (e instanceof O)
                            return new O(this.applyTo(e._value));
                        if (e instanceof C)
                            return new O(this._amount);
                        if (e instanceof t)
                            return new t(this.applyTo(e._amount));
            ...
            var k = function(e) {
                ...
                a(t, [{
                    ...
                    value: function(e) {
                        ...
                        if (e instanceof t)
                            return new t(this.applyTo(e._value));
                    ...
                    value: function(e) {
                        ...
                        if (Array.isArray(e)) {
                            ...
                            return this._value.forEach(function(e) {
                                e instanceof v["default"] ? (0,
                                c["default"])(t, e) || r.push(e) : t.indexOf(e) < 0 && r.push(e)
                            }),
                            e.concat(r)
                        }
                        throw new Error("Cannot add elements to a non-array value")
                        ...
                        if (Array.isArray(e)) {
                            for (var t = e.indexOf(this._value), r = e.concat([]), t = 0; t < this._value.length; t++) {
                                for (var n = r.indexOf(this._value[t]); n > -1; )
                                    r.splice(n, 1),
                                    n = r.indexOf(this._value[t]);
                                if (this._value[t]instanceof v["default"] && this._value[t].id)
                                    for (var a = 0; a < r.length; a++)
                                        r[a]instanceof v["default"] && this._value[t].id === r[a].id && (r.splice(a, 1),
                                        a--)
                            }
                            return r
                        }
                    ...
                    value: function(e) {
                        ...
                        if (e instanceof t) {
                            for (var r = e._value.concat([]), n = 0; n < this._value.length; n++)
                                this._value[n]instanceof v["default"] ? (0,
                                c["default"])(r, this._value[n]) || r.push(this._value[n]) : r.indexOf(this._value[n]) < 0 && r.push(this._value[n]);
                            return new t(r)
                        }
            ...
            var S = function(e) {
                function t(e, r) {
                    ...
                    Array.isArray(e) && (this.relationsToAdd = (0,
                    g["default"])(e.map(this._extractId, this))),
                    Array.isArray(r) && (this.relationsToRemove = (0,
                    g["default"])(r.map(this._extractId, this)))
                }
                return i(t, e),
                a(t, [{
                    key: "_extractId",
                    ...
                    value: function() {
                        var e = this
                          ...
                          , n = null
                          , a = null;
                        return this.relationsToAdd.length > 0 && (a = this.relationsToAdd.map(t),
                        r = {
                            __op: "AddRelation",
                            objects: a
                        }),
                        this.relationsToRemove.length > 0 && (a = this.relationsToRemove.map(t),
                        n = {
                            __op: "RemoveRelation",
                            objects: a
                        }),
                    ...
                    return a(e, [{
                        ...
                        value: function(t, r) {
                            var a = this
                              , s = new e
                              , i = function() {
                                for (var r = arguments.length, n = Array(r), a = 0; r > a; a++)
                                    n[a] = arguments[a];
                                if ("function" == typeof t)
                                    if (o)
                                        try {
                            ...
                            this._resolved ? l(function() {
                                ...
                                u(a._error)
                            }) : (this._resolvedCallbacks.push(i),
                        ...
                        value: function(t, r) {
                            ...
                            ) : "object" == typeof t && ("function" == typeof t.success && (n.success = t.success),
                            "function" == typeof t.error && (n.error = t.error)),
                            this.then(function() {
                                for (var t = arguments.length, r = Array(t), a = 0; t > a; a++)
                                    r[a] = arguments[a];
                                return n.success && n.success.apply(this, r),
                                e.as.apply(e, arguments)
                            }, function(t) {
                                return n.error && ("undefined" != typeof r ? n.error(r, t) : n.error(t)),
                                e.error(t)
                            })
                        }
                    }, {
                        ...
                        value: function(t) {
                            ...
                            for (var i = new e, u = function() {
                                n--,
                                0 >= n && (a ? i.reject(o) : i.resolve.apply(i, s))
                            }, l = function(t, r) {
            ...
            var i = e("./CoreManager")
              ...
              , _ = function() {
                function e(t) {
                    if (s(this, e),
                    "string" == typeof t)
                        "User" === t && u["default"].get("PERFORM_USER_REWRITE") ? this.className = "_User" : this.className = t;
                ...
                return a(e, [{
                    ...
                    value: function() {
                        ...
                        for (var t in this._extraOptions)
                            e[t] = this._extraOptions[t];
                        return e
                    }
                }, {
                    key: "get",
                    ...
                    value: function(e) {
                        ...
                        return n.find(this.className, this.toJSON(), r).then(function(e) {
                            return e.results.map(function(e) {
                                return e.className || (e.className = t.className),
                                v["default"].fromJSON(e)
                            })
                        })._thenRunCallbacks(e)
                    }
                }, {
                    ...
                    value: function(e) {
                        ...
                        return n.limit = 0,
                        n.count = 1,
                        r.find(this.className, n, t).then(function(e) {
                            return e.count
                        })._thenRunCallbacks(e)
                    }
                }, {
                    ...
                    value: function(e) {
                        ...
                        var n = u["default"].getQueryController()
                          , a = this.toJSON();
                        return a.limit = 1,
                        n.find(this.className, a, r).then(function(e) {
                            var r = e.results;
                            if (r[0])
                                return r[0].className || (r[0].className = t.className),
                                v["default"].fromJSON(r[0])
                        })._thenRunCallbacks(e)
                    }
                }, {
                    key: "each",
                    value: function(t, r) {
                        ...
                        this._order || this._skip || this._limit >= 0)
                            return b["default"].error("Cannot iterate on a query with sort, skip, or limit.")._thenRunCallbacks(r);
                        var n = (new b["default"],
                    ...
                    key: "equalTo",
                    value: function(e, t) {
                        return "undefined" == typeof t ? this.doesNotExist(e) : (this._where[e] = (0,
                        c["default"])(t, !1, !0),
                        this)
                    }
                }, {
                    ...
                    key: "near",
                    value: function(e, t) {
                        return t instanceof p["default"] || (t = new p["default"](t)),
                    ...
                    value: function() {
                        ...
                        return r.forEach(function(t) {
                            Array.isArray(t) && (t = t.join()),
                            e._order = e._order.concat(t.replace(/\s/g, "").split(",").map(function(e) {
                                return "-" + e
                            }))
                        }),
                        this
              ...
              , c = function() {
                ...
                return n(e, [{
                    ...
                    value: function(e) {
                        ...
                        return this.parent.set(this.key, t),
                    ...
                    value: function t() {
                        var t;
                        return this.targetClassName ? t = new l["default"](this.targetClassName) : (t = new l["default"](this.parent.className),
        ...
        19: [function(e, t, r) {
            ...
            var u = e("./ParseACL")
              ...
              , p = function(e) {
                function t(e, r) {
                    ...
                    "string" == typeof e && r instanceof l["default"] && (this.setName(e),
                    this.setACL(r))
                }
                return a(t, e),
                s(t, [{
                    ...
                    value: function(e, r) {
                        ...
                        if ("name"in e && e.name !== this.getName()) {
                            ...
                            if (this.id && this.id !== e.objectId)
                                return new f["default"](f["default"].OTHER_CAUSE,"A role's name can only be set before it has been saved.");
                            if ("string" != typeof s)
                                return new f["default"](f["default"].OTHER_CAUSE,"A role's name must be a String.");
                            if (!/^[0-9a-zA-Z\-_ ]+$/.test(s))
                                return new f["default"](f["default"].OTHER_CAUSE,"A role's name can be only contain alphanumeric characters, _, -, and spaces.")
                        }
                        return !1
                    }
                }]),
            ...
            r["default"] = p,
            h["default"].registerSubclass("_Role", p),
            t.exports = r["default"]
        }
        , {
            "./ParseACL": 8,
              ...
              , b = function(e) {
                ...
                s(t, [{
                    ...
                    value: function(e) {
                        ...
                        m["default"].currentAsync().then(function(e) {
                            if (!e)
                                return y["default"].error("There is no current user.");
                            e.getSessionToken();
                            return r.sessionToken = e.getSessionToken(),
                            t.getSession(r)
                        })
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        return e ? (0,
                        f["default"])(e.getSessionToken() || "") : !1
                    }
                }]),
                t
            }(h["default"]);
            r["default"] = b,
            h["default"].registerSubclass("_Session", b),
        ...
        21: [function(e, t, r) {
            ...
            var c = e("./CoreManager")
              ...
              , T = function(e) {
                ...
                s(t, [{
                    ...
                    key: "_logOutWith",
                    value: function(e) {
                        this.isCurrent() && ("string" == typeof e && (e = I[e]),
                    ...
                    value: function(e) {
                        ...
                        t && t.hasOwnProperty("anonymous") && (t.anonymous = null),
                        this.set("username", e)
                    }
                }, {
                    key: "setPassword",
                    ...
                    key: "save",
                    value: function() {
                        for (var e = this, r = arguments.length, a = Array(r), s = 0; r > s; s++)
                            a[s] = arguments[s];
                    ...
                    value: function(e) {
                        if (e = e || {},
                        f["default"].set("FORCE_REVOCABLE_SESSION", !0),
                        E) {
                            var r = t.current();
                            if (r)
                                return r._upgradeToRevocableSession(e)
                        }
                    ...
                    value: function(e) {
                        I[e.getAuthType()] = e,
                        t.currentAsync().then(function(t) {
            ...
            r["default"] = T,
            _["default"].registerSubclass("_User", T);
            var N = {
                updateUserOnDisk: function(e) {
                    var t = k["default"].generatePath(A)
                      , r = e.toJSON();
                    return r.className = "_User",
                ...
                currentUser: function() {
                    ...
                    !t)
                        ...
                        null;
                    t = JSON.parse(t),
                    t.className || (t.className = "_User"),
                    t._id && (t.objectId !== t._id && (t.objectId = t._id),
                    delete t._id),
                    t._sessionToken && (t.sessionToken = t._sessionToken,
                ...
                upgradeToRevocableSession: function(e, t) {
                    ...
                    if (!r)
                        return w["default"].error(new m["default"](m["default"].SESSION_MISSING,"Cannot upgrade a user with no session token"));
                    t.sessionToken = r;
                    var n = f["default"].getRESTController();
                    return n.request("POST", "upgradeToRevocableSession", {}, t).then(function(t) {
                        var r = new C["default"];
                        return r._finishFetch(t),
                        e._finishFetch({
        ...
        22: [function(e, t, r) {
            ...
            function n(e, t) {
                if (t = t || {},
                e.where && e.where instanceof u["default"] && (e.where = e.where.toJSON().where),
                e.push_time && "object" == typeof e.push_time && (e.push_time = e.push_time.toJSON()),
                e.expiration_time && "object" == typeof e.expiration_time && (e.expiration_time = e.expiration_time.toJSON()),
            ...
            (function(n) {
                ...
                var y = {
                    ajax: function(e, t, r, s) {
                        ...
                        var o = new f["default"]
                          ...
                          , l = function c() {
                                ...
                                if (4 === l.readyState && !a)
                                    ...
                                    l.status >= 200 && l.status < 300) {
                                        ...
                                        if (++u < i["default"].get("REQUEST_ATTEMPT_LIMIT")) {
                                            ...
                                            0 === l.status ? o.reject("Unable to connect to the Parse API") : o.reject(l);
                                    else
                                        o.reject(l)
                            }
                            ,
                            ...
                            i["default"].get("IS_NODE") && (s["User-Agent"] = "Parse/" + i["default"].get("VERSION") + " (NodeJS " + n.versions.node + ")"),
                            l.open(e, t, !0);
                            for (var f in s)
                                l.setRequestHeader(f, s[f]);
                            l.send(r)
                        };
                        return l(),
                        o
                    ...
                    request: function(e, t, r, n) {
                        ...
                        s._ClientVersion = i["default"].get("VERSION");
                        var u = n.useMasterKey;
                        if ("undefined" == typeof u && (u = i["default"].get("USE_MASTER_KEY")),
                        u) {
                        ...
                        return c.currentInstallationId().then(function(e) {
                            ...
                            if (e && e.responseText)
                                ...
                                t = new l["default"](l["default"].CONNECTION_FAILED,"XMLHttpRequest failed: " + JSON.stringify(e));
        ...
        27: [function(e, t, r) {
            ...
            function n(e, t) {
                ...
                for (var r = 0; r < e.length; r++)
                    if (e[r]instanceof o["default"] && e[r].className === t.className && e[r]._getId() === t._getId())
                        return !0;
                return !1
            }
            var a = e("babel-runtime/helpers/interop-require-default")["default"];
        ...
        29: [function(e, t, r) {
            ...
            function n(e) {
                ...
                if ("Relation" === e.__type) {
                    ...
                    return r.targetClassName = e.className,
                    r
                }
                if ("Date" === e.__type)
                    return new Date(e.iso);
                if ("File" === e.__type)
                    return i["default"].fromJSON(e);
        ...
        30: [function(e, t, r) {
            ...
            function n(e, t, r, s) {
                if (e instanceof h["default"]) {
                    ...
                    return r || !s || s.indexOf(o) > -1 || e.dirty() || a(e._getServerData()).length < 1 ? e.toPointer() : (s = s.concat(o),
                    e._toFullJSON(s))
                }
                if (e instanceof p.Op || e instanceof i["default"] || e instanceof f["default"] || e instanceof v["default"])
                    return e.toJSON();
                if (e instanceof l["default"]) {
                    if (!e.url())
                ...
                if ("[object RegExp]" === m.call(e) && "string" == typeof e.source)
                    return e.source;
                if (Array.isArray(e))
        ...
        31: [function(e, t, r) {
            ...
            function n(e, t) {
                ...
                if (e instanceof i["default"] || e instanceof l["default"] || e instanceof f["default"] || e instanceof h["default"])
                    return e.equals(t);
        ...
        35: [function(e, t, r) {
            ...
            function n(e) {
                var t = [];
                return e.forEach(function(e) {
                    e instanceof u["default"] ? (0,
                    o["default"])(t, e) || t.push(e) : t.indexOf(e) < 0 && t.push(e)
                }),
                t
            }
            var a = e("babel-runtime/helpers/interop-require-default")["default"];
        ...
        36: [function(e, t, r) {
            ...
            function n(e, t) {
                ...
                var s = e.attributes;
                for (var o in s)
                    "object" == typeof s[o] && a(s[o], r, !1, !!t);
                var i = [];
                for (var u in r.objects)
                    u !== n && r.objects[u] !== !0 && i.push(r.objects[u]);
        ...
        61: [function(e, t, r) {
            var n = e("./$.global")
              ...
              , i = function(e, t, r) {
                ...
                for (u in r)
                    l = !f && b && u in b,
                    l && u in m || (c = l ? b[u] : r[u],
                    m[u] = d && "function" != typeof b[u] ? r[u] : y && l ? s(c, n) : v && b[u] == c ? function(e) {
                        var t = function(t) {
                            return this instanceof e ? new e(t) : e(t)
                        };
                        return t[o] = e[o],
                        t
                    }(c) : p && "function" == typeof c ? s(Function.call, c) : c,
                    p && ((m[o] || (m[o] = {}))[u] = c))
            };
            i.F = 1,
            i.G = 2,
        ...
        68: [function(e, t, r) {
            ...
            t.exports = {
                set: Object.setPrototypeOf || ("__proto__"in {} ? function(t, r, a) {
                    try {
                        a = e("./$.ctx")(Function.call, n(Object.prototype, "__proto__").set, 2),
                        a(t, []),
